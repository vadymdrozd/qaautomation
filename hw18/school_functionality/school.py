...
class School:
    ...
    def get_school_costs(self):
        return self.get_teachers_cost() + self.get_head_teachers_cost() + self.__director.benefit

    def get_study_cost(self, revenue: int):
        """
        ...
        if self.get_school_pupils_list():
            ...
            total_costs = self.get_school_costs() + revenue
