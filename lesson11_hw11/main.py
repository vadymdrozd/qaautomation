...
school_director = Director('Ivan', 'Vasyliovuch', 40)
head_teacher1 = HeadTeacher('Stepan', 'Ivanovych', 35)
teacher1 = Teacher('Dmytro', 'Petrovych', 30)

vasyl = Pupil('Vasyl', 'Vaskov', 16)
olga = Pupil('Olga', 'Vaskova', 16)
dana = Pupil('Dana', 'Petrova', 16)
petro = Pupil('Petro', 'Petrov', 16)
yana = Pupil('Yana', 'Yanina', 16)
dina = Pupil('Dina', 'Dinova', 16)
...
print(first_school.get_study_cost())
#
# print('---------------')
