...
class TestGame(unittest.TestCase):
    ...
    def test_throw_0_0_1(self):
        result = self.dice.throw(0, 1, 1)
    ...
    def test_throw_0_2_2(self):
        result = self.dice.throw(0, 2, 2)
    ...
    def test_throw_0_2_1(self):
        result = self.dice.throw(0, 2, 1)
